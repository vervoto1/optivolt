...
export function getElements() {
  return {
    ...
    evApplyPriceLimit: $("#ev-apply-price-limit"),
    evMaxPrice: $("#ev-max-price"),
    evOpportunisticEnabled: $("#ev-opportunistic-enabled"),
    evOpportunisticLevel: $("#ev-opportunistic-level"),
    evOpportunisticType2Enabled: $("#ev-opportunistic-type2-enabled"),
    evOpportunisticType2Level: $("#ev-opportunistic-type2-level"),
    evLowPriceEnabled: $("#ev-low-price-enabled"),
    evLowPriceLevel: $("#ev-low-price-level"),
    evLowSocEnabled: $("#ev-low-soc-enabled"),
    ...
    // EV tab
    evTabModeRow: $("#ev-tab-mode-row"),
    evTabModeBadge: $("#ev-tab-mode-badge"),
    evTabTargetMet: $("#ev-tab-target-met"),
    evOverrideControls: $("#ev-override-controls"),
    evOverrideHint: $("#ev-override-hint"),
    evOverrideAuto: $("#ev-override-auto"),
    evOverrideCharge: $("#ev-override-charge"),
    evOverrideStop: $("#ev-override-stop"),
