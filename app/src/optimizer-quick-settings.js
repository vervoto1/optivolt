export const QUICK_SETTING_DEFS = [
  ...
  { id: "chargeEfficiency_percent", selector: "#etaC", label: "Battery Charge efficiency (%)", kind: "number" },
  { id: "dischargeEfficiency_percent", selector: "#etaD", label: "Battery Discharge efficiency (%)", kind: "number" },
