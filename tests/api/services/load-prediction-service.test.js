...
// A minimal PredictionRunConfig with activeConfig set
const baseConfig = {
...
describe('runForecast', () => {
  ...
  it('uses lookbackWeeks from activeConfig to compute startTime passed to fetchHaStats', async () => {
    const config = { ...baseConfig, activeConfig: { ...baseConfig.activeConfig, lookbackWeeks: 2 } };
